        ...
        <div class="col s12">
            <div class="card">
                <div class="card-content">
                    ...
                    <a class="waves-effect waves-light btn modal-trigger mb-2 mr-1" href="#modal_add"><i class="fa fa-plus-circle"></i> Tambah Data Guru</a>
                    <div class="row mt-4">
                        <div class="col s12">
...
<div id="modal_add" class="modal">
    <form action="<?= base_url('staff/user/guru') ?>" method="POST" enctype="multipart/form-data">
    <div class="modal-content">
        <h4>Tambah Data Guru</h4>
            <div class="row">
                ...
                <div class="col s12">
                    <select class="select2 browser-default" name="id_matpel">
                        <option value=""></option>
                        <?php foreach($matpel as $row) { ?> 
                        <option value="<?= $row->id_matpel ?>"><?= $row->matpel ?></option>
                        <?php } ?> 
                    </select>
                    <label>Mata Pelajaran Diajar</label>
                </div>
                <div class="input-field col s12">
    ...
    <div class="modal-content">
        <h4>Tambah Data Guru</h4>
            <div class="row">
                ...
                <div class="col s12">
                    <select class="select2-edit<?= $val->id_user ?> browser-default" name="id_matpel">
                        <option value=""></option>
                        <?php foreach($matpel as $row) { ?> 
                            <option value="<?= $row->id_matpel ?>" <?= $val->id_matpel == $row->id_matpel ? 'selected' : '' ?>><?= $row->matpel ?></option>
                        <?php } ?> 
                    </select>
                    <label>Mata Pelajaran Diajar</label>
                </div>
...
<div id="modal_delete<?= $val->id_user ?>" class="modal">
    <form action="<?= base_url("staff/user/guru") ?>" method="POST">
    <div class="modal-content">
...
$(function() {
    ...
    $(".select2").select2({
        ...
        placeholder: "Pilih Mata Pelajaran Diajar",
