        ...
        <div class="col s12">
            <div class="card">
                <div class="card-content">
                    <h4 class="card-title">Data Kepala Bimba</h4>
                    <a class="waves-effect waves-light btn modal-trigger mb-2 mr-1" href="#modal_add"><i class="fa fa-plus-circle"></i> Tambah Data Kepala Bimba</a>
                    <div class="row mt-4">
                        <div class="col s12">
...
<div id="modal_add" class="modal">
    <form action="<?= base_url('staff/user/kepala_bimba') ?>" method="POST" enctype="multipart/form-data">
    <div class="modal-content">
        <h4>Tambah Data Kepala Bimba</h4>
            <div class="row">
...
<div id="modal_delete<?= $val->id_user ?>" class="modal">
    <form action="<?= base_url("staff/user/kepala_bimba") ?>" method="POST">
    <div class="modal-content">
        <h4>Hapus Data Kepala Bimba</h4>
