        ...
        <div class="col s12">
            <div class="card">
                <div class="card-content">
                    ...
                    <a class="waves-effect waves-light btn modal-trigger mb-2 mr-1" href="#modal_add"><i class="fa fa-plus-circle"></i> Tambah Data Siswa</a>
                    <div class="row mt-4">
                        <div class="col s12">
...
<div id="modal_add" class="modal">
    <form action="<?= base_url('wali_kelas/user/siswa') ?>" method="POST" enctype="multipart/form-data">
    <div class="modal-content">
        <h4>Tambah Data Siswa</h4>
            <div class="row">
                <div class="input-field col s12">
                    <input type="text" id="fn" name="username">
                    <input type="hidden" name="id_kelas" value="<?= $this->session->kelas_id ?>">
...
<div id="modal_delete<?= $val->id_user ?>" class="modal">
    <form action="<?= base_url("wali_kelas/user/siswa") ?>" method="POST">
    <div class="modal-content">
